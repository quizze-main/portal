...
const PROFIT_CARDS: BenefitCard[] = [
  ...
  { icon: AlertTriangle, title: 'Сделки не теряются', description: 'Алерты о просроченных заказах — менеджер реагирует до того, как клиент уйдёт' },
  { icon: MessageSquare, title: 'Негатив → рост', description: 'Собираем отзывы с акцентом на негативных. Быстрая реакция возвращает клиентов' },
...
const SAVINGS_CARDS: BenefitCard[] = [
  { icon: MessageCircle, title: 'Без своего приложения', description: 'Всё работает в Telegram — не нужно разрабатывать и поддерживать мобильное приложение' },
  ...
  { icon: Zap, title: 'Задачи в один клик', description: 'Уведомление в Telegram → клик → задача открыта. Без поиска и логинов' },
];
