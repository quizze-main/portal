...
import { RepairsRankingCard, RepairsManagerRow, RepairsSortField } from './RepairsRankingCard';
...
interface RepairsRankingMobileProps {
  rows: RepairsManagerRow[];
...
const sortOptions: { field: RepairsSortField; label: string }[] = [
  { field: 'planPercent', label: '% плана' },
  { field: 'name', label: 'Имя' },
  { field: 'avgRepairPrice', label: 'Ср. ремонта' },
  { field: 'repairsCount', label: 'Кол-во ремонтов' },
  { field: 'lostRevenue', label: 'Потери' },
];

export function RepairsRankingMobile({
  rows,
  showPercentFirst,
  onToggleView,
  onManagerClick,
  ...
  return (
    <div className="bg-card rounded-xl border shadow-sm overflow-hidden">
      ...
      <div className="px-4 py-3 border-b bg-muted/60">
        <h3 className="font-semibold text-foreground mb-2">По менеджерам — Ремонты</h3>
