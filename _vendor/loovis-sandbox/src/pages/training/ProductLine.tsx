...
const lessons: Lesson[] = [
  { id: '1', title: 'Виды оправ и материалы', duration: '15 мин', completed: true, type: 'video' },
  { id: '2', title: 'Линзы: типы и покрытия', duration: '18 мин', completed: true, type: 'video' },
  { id: '3', title: 'Детские оправы', duration: '12 мин', completed: true, type: 'text' },
  { id: '4', title: 'Солнцезащитные очки', duration: '10 мин', completed: false, type: 'video' },
  { id: '5', title: 'Аксессуары и уход', duration: '8 мин', completed: false, type: 'text' },
  { id: '6', title: 'Тест по продуктам', duration: '7 мин', completed: false, type: 'quiz' }
];
      ...
      <div className="p-3 space-y-4 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold text-foreground">Продуктовая линейка оптики</h1>
            <p className="text-xs text-muted-foreground">Детальное изучение ассортимента оправ и линз</p>
          </div>
        </div>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm flex items-center gap-2">
              <Glasses className="w-4 h-4 text-blue-500" />
              О модуле
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
            <p className="text-xs text-muted-foreground leading-relaxed mb-3">
              Углубленное изучение всего ассортимента оптики. Вы изучите различные типы оправ, 
              материалы, виды линз и их покрытий, особенности детской оптики и солнцезащитных очков.
            </p>
        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent className="pt-0 space-y-2">
            <div className="flex items-center justify-between p-2 bg-muted/50 rounded text-xs">
              <span>Каталог оправ 2024</span>
              <Button variant="ghost" size="sm" className="h-5 text-[10px] px-2">
                Скачать
              </Button>
            </div>
            <div className="flex items-center justify-between p-2 bg-muted/50 rounded text-xs">
              <span>Таблица линз и покрытий</span>
              <Button variant="ghost" size="sm" className="h-5 text-[10px] px-2">
                Скачать
              </Button>
            </div>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-r from-primary/5 to-primary/10">
          <CardContent className="p-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-xs">Сертификат специалиста</h3>
