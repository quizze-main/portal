...
const lessons: Lesson[] = [
  { id: '1', title: 'Введение в POS-систему', duration: '5 мин', completed: true, type: 'video' },
  { id: '2', title: 'Регистрация продажи', duration: '8 мин', completed: true, type: 'practice' },
  { id: '3', title: 'Работа с возвратами', duration: '6 мин', completed: false, type: 'practice' },
  { id: '4', title: 'Способы оплаты', duration: '5 мин', completed: false, type: 'video' },
  { id: '5', title: 'Отчеты и закрытие смены', duration: '6 мин', completed: false, type: 'text' },
  { id: '6', title: 'Практический тест', duration: '8 мин', completed: false, type: 'quiz' }
];
...
export default function POSSystem() {
  ...
  const getTypeIcon = (type: Lesson['type']) => {
    switch (type) {
      ...
      case 'practice': return <Monitor className="w-3 h-3" />;
    }
  };
      ...
      <div className="p-3 space-y-4 max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold text-foreground">Работа с POS-системой</h1>
            <p className="text-xs text-muted-foreground">Обучение использованию кассового оборудования</p>
          </div>
        </div>
        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent className="pt-0">
            <p className="text-xs text-muted-foreground leading-relaxed mb-3">
              Практическое обучение работе с кассовой системой. Изучите все этапы продажи: 
              от регистрации товара до завершения транзакции и формирования отчетов.
            </p>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-r from-blue-50 to-blue-100">
          <CardContent className="p-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-xs">Симулятор POS</h3>
                <p className="text-[10px] text-muted-foreground leading-tight">
                  Тренируйтесь на виртуальной кассе
                </p>
              </div>
              <Button size="sm" variant="outline" className="text-[10px] px-2 py-1 h-6">
                Запустить
              </Button>
            </div>
          </CardContent>
        ...
        <Card className="border-0 shadow-sm bg-gradient-to-r from-primary/5 to-primary/10">
          <CardContent className="p-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-xs">Сертификат кассира</h3>
                <p className="text-[10px] text-muted-foreground leading-tight">
